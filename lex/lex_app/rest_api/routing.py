...
from lex.lex_app.rest_api.consumers.UpdateCalculationStatusConsumer import (
...
websocket_urlpatterns = [
    ...
    path(
        "ws/calculation_logs/<str:calculationId>",
        CalculationLogConsumer.as_asgi(),
        name="calculation-logs",
    ),
    path(
        "ws/calculation_status_update",
        UpdateCalculationStatusConsumer.as_asgi(),
